# FirstSetup - Academic Portfolio Repository
...
### Semester 1 Projects
- **`python_1/` & `python_2/`**: Word Search Game implementation with GUI
  - Interactive desktop word search puzzle game
  - Features custom word input, timer, scoring, and pause functionality
  - Built with Python, includes loops, conditionals, functions, file handling, and exception handling
  - Demonstrates basic Python concepts for beginners

- **`logic_1/`**: Project documentation and planning
  - Flowcharts, algorithms, and timelines for Python projects
  - Core features: user input (3 words), predefined word list, GUI grid generation, timer, and scoring

- **`prompt_engineering_1/`**: AI-assisted development documentation
  - How I used Google and ChatGPT for semester 1 projects
  - Examples of syntax correction and keyword assistance for Python development

- **`unix_1/` & `unix_2/`**: Unix/Linux command line exercises
  - Basic commands: `cd`, `ls`, `touch`, `cat`, `chmod`
  - Advanced commands: `cp`, `mv`, `echo`, `shell`, `less`

- **`version_control_1/`**: Git and GitHub setup and usage
  - Repository configuration and version control workflows

### Cybersecurity Foundations
- **`cybersecurity_basics_1/`**: Introductory cybersecurity concepts
  - Core principles and foundational knowledge
  - PDF: `Cybersecurity_Basics_1_Saroj.pdf`

- **`cybersecurity_basic_2/`**: Advanced cybersecurity basics
  - Fundamental concepts, best practices, and security measures
  - PDF: `Cybersecurity_Basics_2.pdf`

- **`cyber_threats_and_vulnerabilities_1/`**: Threat analysis
  - Cyber threats, vulnerability types, and mitigation strategies
  - PDF: `Cyber_Threats_and_Vulnerabilities_1.pdf`

### Risk Management & Compliance
- **`risk_management_1/`**: Risk management implementation
  - Risk management processes and methodologies
  - PDF: `Risk Management Implementation.pdf`

- **`compliance_1/`**: Compliance fundamentals
  - PDF: `Compliance 1.pdf`

### Secure Software Development
- **`secure_software_development_1/`**: GRC Portal project
  - Secure software development practices
  - Includes GRC Portal source code demonstrating secure development
  - PDF: `Secure Software Development – GRC Portal Project.pdf`

### Semester 2 Materials
- **`semester_2/`**: Professional development materials
  - GitHub Pages site, job descriptions, project documentation, resume, LinkedIn profile
  - Cybersecurity Compliance Checker project planning

### Semester 3 Projects
- **`semester_3/`**: Advanced coursework
  - GRC Portal application development

### Major Projects

#### 🎯 Word Search Game (Semester 1)
Interactive desktop word search puzzle game with the following features:
- **Custom Word Input**: Users enter 3 custom words
- **Gameplay**: Start/pause timer, word finding with visual feedback
- **Controls**: Show score & reset, undo all clicks
...
- **`githubpages/`**: GitHub Pages deployment files
  - Static site hosting configuration

- **`learning/`**: Advanced learning projects
  - Data archiving and retention implementation
  - Flask-SQLAlchemy migrations and APScheduler integration

- **`coding_practice/`**: Programming exercises and problem-solving
  - Stack implementation, list sorting algorithms
...
### Word Search Game
- **Location**: `python_1/`, `python_2/`, `logic_1/`
